...
- 华为 EMUI 系统最新版本(341以上)，激活 ADB 后可能会出现手机重启丢失个别系统应用的现象，这是 EMUI 系统最新版本的 Bug 导致的，请谨慎激活。出现此问题后的解决方法：隐藏丢失的应用后再取消隐藏即可。卸载应用并重启手机后亦可恢复。
...
- 答：这是 EMUI 系统最新版本(341以上)的 Bug 导致的，出现此问题后的解决方法：隐藏丢失的应用后再取消隐藏即可。卸载应用并重启手机后亦可恢复。
